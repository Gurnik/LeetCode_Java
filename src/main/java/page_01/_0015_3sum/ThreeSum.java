 ...
 * 3 <= nums.length <= 3000
 *
 * Hint1: So, we essentially need to find three numbers x, y, and z such that they add up to the given value.
 * If we fix one of the numbers say x, we are left with the two-sum problem at hand!
 *
 * Hint2: For the two-sum problem, if we fix one of the numbers, say x,
 ...
 *
 * Hint3: The second train of thought for two-sum is, without changing the array,
