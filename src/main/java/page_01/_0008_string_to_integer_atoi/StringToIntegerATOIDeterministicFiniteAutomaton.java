...
public class StringToIntegerATOIDeterministicFiniteAutomaton implements StringToIntegerATOI {
    ...
    public static void main(String[] args) {
        StringToIntegerATOI fut = new StringToIntegerATOIDeterministicFiniteAutomaton();
        String s = "42";
